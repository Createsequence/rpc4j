...
import io.github.createsequence.common.util.StringUtils;
 ...
 */
public class Rpc4jException extends RuntimeException {
     ...
     */
    public Rpc4jException(String messageTemplate, Object... args) {
     ...
     * @since 1.4
     */
    public Rpc4jException(Throwable cause) {
        super(cause);
    }
}
