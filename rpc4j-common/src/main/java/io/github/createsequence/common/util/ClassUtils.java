...
public class ClassUtils {
     ...
     * @param className 类名
     * @return 类实例
     * @throws Rpc4jException 如果找不到类
     */
    public static Class<?> forName(String className) throws Rpc4jException {
     ...
     * @return 类实例或默认类
     * @throws Rpc4jException 如果找不到由 className 指定的类
     */
     ...
     * @param <T>  类型
     * @return 新实例
     * @throws Rpc4jException 如果创建实例失败
     */
