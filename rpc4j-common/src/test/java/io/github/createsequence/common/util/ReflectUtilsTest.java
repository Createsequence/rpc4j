...
public class ReflectUtilsTest {
    ...
    public void invokeRaw() {
        ...
        Assert.assertThrows(Rpc4jException.class, () -> ReflectUtils.invokeRaw(this, method, "arg0"));
        Assert.assertThrows(Rpc4jException.class, () -> ReflectUtils.invokeRaw(this, method, 12));
        ...
        Assert.assertTrue(ex instanceof Rpc4jException);
    ...
    public void getFieldValue() {
        ...
        Assert.assertThrows(Rpc4jException.class, () -> ReflectUtils.getFieldValue(null, ReflectUtils.getDeclaredField(Foo.class, "flag")));
