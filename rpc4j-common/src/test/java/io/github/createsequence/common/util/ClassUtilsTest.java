...
public class ClassUtilsTest {
    ...
    public void forName() {
        ...
        Assert.assertThrows(Rpc4jException.class, () -> ClassUtils.forName("not.found.class"));
        ...
        Assert.assertThrows(Rpc4jException.class, () -> ClassUtils.forName("not.found.class", ClassUtilsTest.class));
    }
    ...
    public void newInstance() {
        ...
        Assert.assertThrows(Rpc4jException.class, () -> ClassUtils.newInstance(Foo.class));
    }
